...
public class TenthLevel extends FightLevel {
    ...
    private final float[] meteorCooldowns = {6.0f, 5.0f, 4.0f, 3.0f}; // Кулдаун метеоритів для кожної хвилі
    ...
    public TenthLevel(float x, float y, float width, float height, GameMap gameMap, List<Bullet> bullets, List<Enemy> enemiesToAdd) {
        ...
        this.levelEnemies = new EnemyType[][]{
            // Хвиля 1: 2× TURRET_BURST + 2× TELEPORTER + 2× GHOST + 3× LONG_ATTACK
            {EnemyType.TURRET_BURST, EnemyType.TURRET_BURST, EnemyType.TELEPORTER, EnemyType.TELEPORTER, EnemyType.GHOST, EnemyType.GHOST, EnemyType.LONG_ATTACK, EnemyType.LONG_ATTACK, EnemyType.LONG_ATTACK},
//            // Хвиля 2: 1× HEALER + 2× TURRET_RANDOM + 3× MATRIARCH + 2× SHORT_ATTACK
//            {EnemyType.HEALER, EnemyType.TURRET_RANDOM, EnemyType.TURRET_RANDOM, EnemyType.MATRIARCH, EnemyType.MATRIARCH, EnemyType.MATRIARCH, EnemyType.SHORT_ATTACK, EnemyType.SHORT_ATTACK},
//            // Хвиля 3: 2× TURRET_BURST + 3× TELEPORTER + 3× GHOST + 2× LONG_ATTACK
//            {EnemyType.TURRET_BURST, EnemyType.TURRET_BURST, EnemyType.TELEPORTER, EnemyType.TELEPORTER, EnemyType.TELEPORTER, EnemyType.GHOST, EnemyType.GHOST, EnemyType.GHOST, EnemyType.LONG_ATTACK, EnemyType.LONG_ATTACK},
//            // Хвиля 4: 2× HEALER + 2× TURRET_BURST + 3× MATRIARCH + 2× TELEPORTER + 2× GHOST
//            {EnemyType.HEALER, EnemyType.HEALER, EnemyType.TURRET_BURST, EnemyType.TURRET_BURST, EnemyType.MATRIARCH, EnemyType.MATRIARCH, EnemyType.MATRIARCH, EnemyType.TELEPORTER, EnemyType.TELEPORTER, EnemyType.GHOST, EnemyType.GHOST}
        };
    }
