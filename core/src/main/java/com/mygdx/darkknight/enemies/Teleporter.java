...
public class Teleporter extends Enemy {
    ...
    public Teleporter(float x, float y, GameMap gameMap, Rectangle roomBounds) {
        ...
        super(Assets.teleporterTexture, // Використовуємо спеціальну текстуру для телепортера
              x, 
              y, 
              32, 
              32, 
        ...
        this.teleportEffectTexture = Assets.teleportEffectTexture; // Використовуємо спеціальну текстуру для ефекту телепортації
